...
package com.reyansh.audio.audioplayer.free.Utils.helper;
...
/**
 * An implementation of {@link ItemTouchHelper.Callback} that enables basic drawable_drag & drop and
...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        cardView.setBackgroundColor(ContextCompat.getColor(viewHolder.itemView.getContext(), R.color.colorPrimary));
        mBeingDrawn = true;
